    ...
    <header className="bg-white">
        <div className="xl:container xl:mx-auto flex flex-col items-center sm:flex-row sm:justify-between text-center py-3">
              ...
              <div className="md:flex-none md:w-96 w-72 flex justify-center py-4 sm:py-0">
                <input type="text" className="mt-1 block w-96 px-3 bg-white border-slate-300 rounded-md text-sm placeholder-slate-500 shadow-md shadow-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Select your preferred states" />
            </div>
